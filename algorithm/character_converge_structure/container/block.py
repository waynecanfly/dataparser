...
from algorithm.character_converge_structure import judge_text_type
...
class Block:
    ...
    def add(self, word):
        # judge if the word can be add to this block
        # don't use lineindex to judge two words if in the same line, because ` should be special treatment
        if self.pageNum == 3 and self.text == 'Notes':
            pass
